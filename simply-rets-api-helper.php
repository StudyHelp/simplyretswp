        ...
        if( get_option('sr_show_leadcapture') ) {
            ...
            if (isset($_ENV['CONTACT_LISTING_FORM_ID']) and function_exists('do_shortcode')) {
                $contact_markup = '<div id="sr-contact-form"><h3>Contact us about listing</h3>'.
                    do_shortcode( '[contact-form-7 id="'.$_ENV['CONTACT_LISTING_FORM_ID'].'" title="Contact Listing Form" html_id="quote-form"]' )
                    .'</div>';
            } else {
...
HTML;
    ...
    public static function srContactFormMarkup($listing, $withHr = true) {
        ...
        $markup .= '<input type="text" placeholder="Name" name="sr-cf-name" value="'
        ...
        $markup .= '<input type="text"  placeholder="Subject" name="sr-cf-subject" value="'
